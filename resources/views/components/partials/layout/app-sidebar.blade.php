        ...
        <x-partials.layout.sidebar-menu>
            ...
            @if(!$isClientRole)
                ...
                >
                    ...
                    <x-partials.layout.sidebar-menu-item 
                        href="{{ route('main.competitions.index', ['organizationId' => $organizationId]) }}"
                        :is-active="request()->routeIs('main.competitions.*')"
                    >
                        Competitions
                    </x-partials.layout.sidebar-menu-item>
                </x-partials.layout.sidebar-collapsible>
            ...
            @if(!$hasBrandSelected)
                ...
                <x-partials.layout.sidebar-collapsible 
                    label="Paid Ads"
                    :icon="$icon('paid-ads')"
                    :default-open="request()->routeIs('main.paid-ads.*') || request()->routeIs('main.paid-campaigns.*')"
                >
                    <x-partials.layout.sidebar-menu-item 
                        href="{{ route('main.paid-ads.campaigns', ['organizationId' => $organizationId]) }}"
                        :is-active="request()->routeIs('main.paid-ads.campaigns') || request()->routeIs('main.paid-campaigns.*')"
                    >
                        Ad Campaigns
                    </x-partials.layout.sidebar-menu-item>
                    <x-partials.layout.sidebar-menu-item 
                        href="{{ route('main.paid-ads.ad-copy', ['organizationId' => $organizationId]) }}"
                        :is-active="request()->routeIs('main.paid-ads.ad-copy')"
                    >
                        Ad Copy Gen
                    </x-partials.layout.sidebar-menu-item>
                    <x-partials.layout.sidebar-menu-item 
                        href="{{ route('main.paid-ads.keyword-research', ['organizationId' => $organizationId]) }}"
                        :is-active="request()->routeIs('main.paid-ads.keyword-research')"
                    >
                        Keyword Res
                    </x-partials.layout.sidebar-menu-item>
                </x-partials.layout.sidebar-collapsible>
                ...
                <x-partials.layout.sidebar-menu-item 
                    href="{{ route('main.press-releases.index', ['organizationId' => $organizationId]) }}"
                    :is-active="request()->routeIs('main.press-releases.*')"
                >
                    Press Releases
                </x-partials.layout.sidebar-menu-item>
                <x-partials.layout.sidebar-menu-item 
                    href="{{ route('main.reports.index', ['organizationId' => $organizationId]) }}"
                    :is-active="request()->routeIs('main.reports.*')"
                >
                    Reports
                </x-partials.layout.sidebar-menu-item>
                <x-partials.layout.sidebar-menu-item 
                    href="{{ route('main.reviews.index', ['organizationId' => $organizationId]) }}"
                    :is-active="request()->routeIs('main.reviews.*')"
                >
                    Reputation
                </x-partials.layout.sidebar-menu-item>
                @endif

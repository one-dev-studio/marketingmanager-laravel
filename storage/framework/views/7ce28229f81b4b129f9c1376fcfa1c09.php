<?php $__env->startSection('page-title', 'Chatbots'); ?>
...
<div class="container mx-auto px-4 py-6" x-data="chatbotManager()">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            ...
            <a
                href="<?php echo e(route('main.chatbots.builder', ['organizationId' => $orgId])); ?>"
                ...
                <div class="p-6 hover:bg-gray-50 transition-colors">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-2">
                            <a
                                :href="`/main/<?php echo e($orgId); ?>/chatbots/${chatbot.id}`"
                            ...
                            <a
                                :href="`<?php echo e(route('main.chatbots.deployment', ['organizationId' => $orgId])); ?>?id=${chatbot.id}`"
                                class="text-gray-400 hover:text-gray-600 p-2"
                            ...
                            <a
                                :href="`<?php echo e(route('main.chatbots.analytics', ['organizationId' => $orgId])); ?>?id=${chatbot.id}`"
                                class="text-gray-400 hover:text-gray-600 p-2"
                            ...
                            <a
                                :href="`<?php echo e(route('main.chatbots.builder', ['organizationId' => $orgId])); ?>?id=${chatbot.id}`"
                                class="text-gray-400 hover:text-gray-600 p-2"
                                title="Edit chatbot"
                            >
                                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <a
                                :href="`<?php echo e(route('main.chatbots.builder', ['organizationId' => $orgId])); ?>?duplicate=${chatbot.id}`"
                                class="text-gray-400 hover:text-gray-600 p-2"
...
function chatbotManager() {
    return {
        chatbots: <?php echo json_encode($chatbots->getCollection()->values(), 15, 512) ?>,
        searchQuery: '',
        statusFilter: '',
        loading: false,
        ...
        loadChatbots() {
            ...
            fetch(`<?php echo e(route('main.chatbots.index', ['organizationId' => $orgId])); ?>?${params}`, {
                headers: {
        ...
        duplicateChatbot(chatbot) {
            ...
            window.location.href = `<?php echo e(route('main.chatbots.builder', ['organizationId' => $orgId])); ?>?duplicate=${chatbot.id}`;
        },

        async toggleChatbotStatus(chatbot) {
            try {
                const response = await fetch(`/main/<?php echo e($orgId); ?>/chatbots/${chatbot.id}`, {
                    method: 'PUT',
                    headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\marketingmanager-laravel\resources\views/chatbots/index.blade.php ENDPATH**/ ?>
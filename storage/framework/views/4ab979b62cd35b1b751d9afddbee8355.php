<?php $__env->startSection('page-title', 'Brand name generator'); ?>

<?php $__env->startSection('content'); ?>
<div class="space-y-6"
     x-data="chooseName({
        generateUrl: <?php echo \Illuminate\Support\Js::from(route('main.brands.name-generator.generate', ['organizationId' => $organizationId]))->toHtml() ?>,
        domainUrl: <?php echo \Illuminate\Support\Js::from(route('main.brands.name-generator.check-domain', ['organizationId' => $organizationId]))->toHtml() ?>,
        handlesUrl: <?php echo \Illuminate\Support\Js::from(route('main.brands.name-generator.check-handles', ['organizationId' => $organizationId]))->toHtml() ?>,
        createUrl: <?php echo \Illuminate\Support\Js::from(route('main.brands.create', ['organizationId' => $organizationId]))->toHtml() ?>,
        csrf: <?php echo \Illuminate\Support\Js::from(csrf_token())->toHtml() ?>,
        existing: <?php echo \Illuminate\Support\Js::from($suggestions->map(fn ($s) => [
            'id' => $s->id,
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="<?php echo e(route('main.brands.index', ['organizationId' => $organizationId])); ?>" class="text-sm text-gray-600 hover:text-gray-900">Back to brands</a>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\marketingmanager-laravel\resources\views/brands/choose-name.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <title><?php echo e(isset($title) ? $title . ' - ' : ''); ?>MarketPulse</title>
...
<body class="bg-gray-50 antialiased">
    ...
    >
        ...
        <?php if($organizationId): ?>
            <?php echo $__env->make('partials.layout.app-sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($pageTitle),'showMobileMenuToggle' => true,'showOrganizationSwitcher' => true,'showCalendarDialog' => true,'showReviewIndicator' => true,'showNotifications' => true]); ?>
...
<?php /**PATH D:\projects\marketingmanager-laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>
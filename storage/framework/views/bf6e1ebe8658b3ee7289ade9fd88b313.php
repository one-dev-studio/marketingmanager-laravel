...
<head>
    ...
    <title><?php echo e(isset($title) ? $title . ' - ' : ''); ?>MarketPulse - AI-Powered Marketing Automation Platform</title>
...
<body class="antialiased">
        ...
        <div class="container">
            <div class="navbar-content">
                ...
                <div class="navbar-menu" id="navbarMenu">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="nav-link navbar-menu-auth">Login</a>
                    <a href="<?php echo e(route('register')); ?>" class="nav-link navbar-menu-auth">Get Started</a>
                </div>
            ...
            <div class="footer-grid">
                ...
                <div class="footer-col">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="<?php echo e(route('integrations')); ?>">Integrations</a></li>
                        <li><a href="<?php echo e(route('developer')); ?>">API</a></li>
                    </ul>
                </div>
                ...
                <div class="footer-col">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="<?php echo e(route('gdpr')); ?>">GDPR</a></li>
                    </ul>
                </div>
            </div>

            <div class="footer-bottom">
                <p>&copy; <?php echo e(date('Y')); ?> MarketPulse. All rights reserved.</p>
    ...
    <div id="cookie-banner" class="fixed bottom-0 inset-x-0 bg-gray-900 text-white p-4 text-sm flex justify-between gap-4" style="display:none">
        <p>We use cookies for analytics and to improve the site. <a href="<?php echo e(route('privacy')); ?>" class="underline">Learn more</a>.</p>
...
<?php /**PATH D:\projects\marketingmanager-laravel\resources\views/layouts/public.blade.php ENDPATH**/ ?>
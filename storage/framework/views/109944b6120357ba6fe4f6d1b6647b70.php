...
<div class="container mx-auto px-4 py-6" x-data="workflowManager()">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            ...
            <a
                href="<?php echo e(route('main.workflows.builder', ['organizationId' => $orgId])); ?>"
                ...
                <div class="p-6 hover:bg-gray-50 transition-colors">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-2">
                            <a
                                :href="`<?php echo e(route('main.workflows.builder', ['organizationId' => $orgId])); ?>?id=${workflow.id}`"
...
function workflowManager() {
    return {
        workflows: <?php echo json_encode($workflows->getCollection()->values(), 15, 512) ?>,
        searchQuery: '',
        statusFilter: '',
        loading: false,
        ...
        loadWorkflows() {
            ...
            fetch(`<?php echo e(route('main.workflows.index', ['organizationId' => $orgId])); ?>?${params}`, {
                headers: {
        ...
        duplicateWorkflow(workflow) {
            ...
            window.location.href = `<?php echo e(route('main.workflows.builder', ['organizationId' => $orgId])); ?>?duplicate=${workflow.id}`;
        },

        async toggleWorkflowStatus(workflow) {
            try {
                const response = await fetch(`/main/<?php echo e($orgId); ?>/workflows/${workflow.id}`, {
                    method: 'PUT',
                    headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\marketingmanager-laravel\resources\views/workflows/index.blade.php ENDPATH**/ ?>